...
(function () {
  ...
  function xa(k, m) {
    xa.base.constructor.call(this, "Title", "title", m, null, k);
    this.chart = k;
    this.canvas = k.canvas;
    this.ctx = this.chart.ctx;
    ...
    if (s(this.options.margin) && k.options.subtitles)
      for (var v = k.options.subtitles, u = 0; u < v.length; u++)
        if (
          ((s(v[u].horizontalAlign) && "center" === this.horizontalAlign) ||
            v[u].horizontalAlign === this.horizontalAlign) &&
          ((s(v[u].verticalAlign) && "top" === this.verticalAlign) ||
            v[u].verticalAlign === this.verticalAlign) &&
          !v[u].dockInsidePlotArea === !this.dockInsidePlotArea
        ) {
          this.margin = 0;
          break;
        }
  ...
  (function () {
    ...
    J._fTWm = function (k) {
      if ("undefined" === typeof J.pro.sCH && !ab)
        try {
  ...
  var eb = (function () {
        ...
        if (((m = M.pop()), "#" === m || "0" === m))
          if ((N++, N === P)) {
            ...
            for (; 0 < X.length; )
              (v = X.pop() + v),
                Q++,
                0 === Q % E && L === V && 0 < X.length && (v = y + v);
          } else
            0 < D.length
              ? ((v = D.pop() + v), J++, Q++)
              : "0" === m && ((v = "0" + v), J++, Q++),
              0 === Q % E && L === V && 0 < D.length && (v = y + v);
        else
          ("E" !== m[0] && "e" !== m[0]) ||
          "0" !== m[m.length - 1] ||
          !/[eE][+-]*[0]+/.test(m)
            ? "," === m
              ? (L++, (E = Q), (Q = 0), 0 < D.length && (v = y + v))
              : (v =
                  1 < m.length &&
                  (('"' === m[0] && '"' === m[m.length - 1]) ||
                    ("'" === m[0] && "'" === m[m.length - 1]))
    ...
    ca = function (k, m, v, s, u, y, D, E, N, M, Q, P, I) {
      ...
      0 < D &&
        ...
        (k.strokeStyle = E),
        k.moveTo(m, v),
        k.rect(m - I, v - I, s - m + 2 * I, u - v + 2 * I),
        k.stroke());
      k.restore();
      !0 === N &&
        (k.save(),
        ...
        k.lineTo(s, v),
        k.closePath(),
        (D = k.createLinearGradient((s + m) / 2, v + J, (s + m) / 2, v)),
        D.addColorStop(0, y),
      ...
      !0 === Q &&
        ...
        k.lineTo(m, u),
        k.closePath(),
        (D = k.createLinearGradient(m + J, (u + v) / 2, m, (u + v) / 2)),
        D.addColorStop(0, y),
      ...
      !0 === P &&
        ...
        k.lineTo(s - J, u - J),
        k.lineTo(s, u),
        (D = k.createLinearGradient(s - J, (u + v) / 2, s, (u + v) / 2)),
        D.addColorStop(0, y),
        D.addColorStop(1, "rgba(255, 255, 255, 0.1)"),
        (k.fillStyle = D),
        D.addColorStop(0, y),
  ...
  W.prototype.setOptions = function (k, m) {
    if (pa[this._defaultsKey]) {
      ...
      for (s in v)
        "publicProperties" !== s &&
          v.hasOwnProperty(s) &&
          (this[s] = k && s in k ? k[s] : m && s in m ? m[s] : v[s]);
  ...
  y = Na.Chart = (function () {
    ...
    function v(a, d) {
      for (var c = [], b, e = 0; e < a.length; e++)
        if (0 == e) c.push(a[0]);
          ...
          b = (a[p].y - a[f].y) / b;
          c[c.length] =
            (a[l].x > a[f].x && 0 < A) || (a[l].x < a[f].x && 0 > A)
              ? { x: a[l].x + A / 3, y: a[l].y + b / 3 }
              : { x: a[l].x, y: a[l].y + b / 9 };
          l = e;
          f = 0 === l ? 0 : l - 1;
          p = l === a.length - 1 ? l : l + 1;
    ...
    m.prototype.renderElements = function () {
      ...
      for (d = 0; d < this.plotInfo.plotTypes.length; d++)
        for (
          ...
          l.targetCanvas = null;
          this.animatedRender &&
            ((l.targetCanvas = sa(this.width, this.height)),
          ...
          "line" === l.type
            ? (A = this.renderLine(l))
            : "stepLine" === l.type
            ? (A = this.renderStepLine(l))
            : "spline" === l.type
            ? (A = this.renderSpline(l))
            : "column" === l.type
            ? (A = this.renderColumn(l))
            : "bar" === l.type
            ? (A = this.renderBar(l))
            : "area" === l.type
            ? (A = this.renderArea(l))
            : "stepArea" === l.type
            ? (A = this.renderStepArea(l))
            : "splineArea" === l.type
            ? (A = this.renderSplineArea(l))
            : "stackedColumn" === l.type
            ? (A = this.renderStackedColumn(l))
            : "stackedColumn100" === l.type
            ? (A = this.renderStackedColumn100(l))
            : "stackedBar" === l.type
            ? (A = this.renderStackedBar(l))
            : "stackedBar100" === l.type
            ? (A = this.renderStackedBar100(l))
            : "stackedArea" === l.type
            ? (A = this.renderStackedArea(l))
            : "stackedArea100" === l.type
            ? (A = this.renderStackedArea100(l))
            : "bubble" === l.type
            ? (A = A = this.renderBubble(l))
            : "scatter" === l.type
            ? (A = this.renderScatter(l))
            : "pie" === l.type
            ? this.renderPie(l)
            : "doughnut" === l.type
            ? this.renderPie(l)
            : "funnel" === l.type
            ? (A = this.renderFunnel(l))
            : "pyramid" === l.type
            ? (A = this.renderFunnel(l))
            : "candlestick" === l.type
            ? (A = this.renderCandlestick(l))
            : "ohlc" === l.type
            ? (A = this.renderCandlestick(l))
            : "rangeColumn" === l.type
            ? (A = this.renderRangeColumn(l))
            : "error" === l.type
            ? (A = this.renderError(l))
            : "rangeBar" === l.type
            ? (A = this.renderRangeBar(l))
            : "rangeArea" === l.type
            ? (A = this.renderRangeArea(l))
            : "rangeSplineArea" === l.type
            ? (A = this.renderRangeSplineArea(l))
            : "waterfall" === l.type
            ? (A = this.renderWaterfall(l))
            : "boxAndWhisker" === l.type && (A = this.renderBoxAndWhisker(l));
          for (var h = 0; h < l.dataSeriesIndexes.length; h++)
            this._dataInRenderedOrder.push(this.data[l.dataSeriesIndexes[h]]);
          this.animatedRender &&
            ((l.targetCanvasCtx.miterLimit = e), A && c.push(A));
        }
          ...
          if ("normal" === l.axisPlacement || "xySwapped" === l.axisPlacement)
            var q = a.axisX.sessionVariables.newViewportMinimum
              ...
              g = a.axisX.sessionVariables.newViewportMaximum
                ...
                : Infinity;
          if (
            (l.dataPoints[A].x && l.dataPoints[A].x.getTime) ||
            "dateTime" === l.xValueType
          )
            f = !0;
          for (A = 0; A < l.dataPoints.length; A++) {
            "undefined" === typeof l.dataPoints[A].x &&
              (l.dataPoints[A].x = A + (a.axisX.logarithmic ? 1 : 0));
            l.dataPoints[A].x.getTime
              ? ((f = !0), (b = l.dataPoints[A].x.getTime()))
              : (b = l.dataPoints[A].x);
            e = l.dataPoints[A].y;
            b < c.min && (c.min = b);
            b > c.max && (c.max = b);
            ...
            if (0 < A) {
              if (a.axisX.logarithmic) {
                var w = b / l.dataPoints[A - 1].x;
                1 > w && (w = 1 / w);
                c.minDiff > w && 1 !== w && (c.minDiff = w);
              } else
                (w = b - l.dataPoints[A - 1].x),
                  0 > w && (w *= -1),
                  c.minDiff > w && 0 !== w && (c.minDiff = w);
              null !== e &&
                null !== l.dataPoints[A - 1].y &&
                (a.axisY.logarithmic
                  ? ((w = e / l.dataPoints[A - 1].y),
                    1 > w && (w = 1 / w),
                    d.minDiff > w && 1 !== w && (d.minDiff = w))
                  : ((w = e - l.dataPoints[A - 1].y),
                    0 > w && (w *= -1),
                    d.minDiff > w && 0 !== w && (d.minDiff = w)));
            }
            if (b < q && !h) null !== e && (r = b);
            else {
              if (!h && ((h = !0), 0 < A)) {
              ...
              l.dataPoints[A].label &&
                (a.axisX.labels[b] = l.dataPoints[A].label);
      ...
      if (
        ...
        for (
          ...
          if (
            ...
            f = !0;
          for (A = 0; A < l.dataPoints.length; A++)
            "undefined" !== typeof l.dataPoints[A].isCumulativeSum &&
            !0 === l.dataPoints[A].isCumulativeSum
              ? ((l.dataPointEOs[A].cumulativeSumYStartValue = 0),
                (l.dataPointEOs[A].cumulativeSum =
                  0 === A ? 0 : l.dataPointEOs[A - 1].cumulativeSum),
                (l.dataPoints[A].y =
                  0 === A ? 0 : l.dataPointEOs[A - 1].cumulativeSum))
              : "undefined" !== typeof l.dataPoints[A].isIntermediateSum &&
                !0 === l.dataPoints[A].isIntermediateSum
              ? ((l.dataPointEOs[A].cumulativeSumYStartValue = r),
                (l.dataPointEOs[A].cumulativeSum =
                  0 === A ? 0 : l.dataPointEOs[A - 1].cumulativeSum),
                (l.dataPoints[A].y = 0 === A ? 0 : b),
                (r = 0 === A ? 0 : l.dataPointEOs[A - 1].cumulativeSum),
                (b = 0))
              : ((e =
                  "number" !== typeof l.dataPoints[A].y
                    ? 0
                    : l.dataPoints[A].y),
                (l.dataPointEOs[A].cumulativeSumYStartValue =
                  0 === A ? 0 : l.dataPointEOs[A - 1].cumulativeSum),
                (l.dataPointEOs[A].cumulativeSum =
                  0 === A ? e : l.dataPointEOs[A - 1].cumulativeSum + e),
                (b += e));
          for (A = 0; A < l.dataPoints.length; A++)
            if (
              ("undefined" === typeof l.dataPoints[A].x &&
              ...
              b < c.min && (c.min = b),
              b > c.max && (c.max = b),
              l.dataPointEOs[A].cumulativeSum < d.min &&
                (d.min = l.dataPointEOs[A].cumulativeSum),
              l.dataPointEOs[A].cumulativeSum > d.max &&
                (d.max = l.dataPointEOs[A].cumulativeSum),
              0 < A &&
                (a.axisX.logarithmic
                  ? ((r = b / l.dataPoints[A - 1].x),
                    1 > r && (r = 1 / r),
                ...
                null !== e &&
                  ...
                  (a.axisY.logarithmic
                    ? ((e =
                        l.dataPointEOs[A].cumulativeSum /
                        l.dataPointEOs[A - 1].cumulativeSum),
                      1 > e && (e = 1 / e),
              ...
              b > c.viewPortMax && (c.viewPortMax = b);
              0 < A &&
                (l.dataPointEOs[A - 1].cumulativeSum < d.viewPortMin &&
                  (d.viewPortMin = l.dataPointEOs[A - 1].cumulativeSum),
                l.dataPointEOs[A - 1].cumulativeSum > d.viewPortMax &&
                  (d.viewPortMax = l.dataPointEOs[A - 1].cumulativeSum));
              l.dataPointEOs[A].cumulativeSum < d.viewPortMin &&
                (d.viewPortMin = l.dataPointEOs[A].cumulativeSum);
              l.dataPointEOs[A].cumulativeSum > d.viewPortMax &&
                (d.viewPortMax = l.dataPointEOs[A].cumulativeSum);
            }
          l.axisX.valueType = l.xValueType = f ? "dateTime" : "number";
        }
    };
      ...
      for (p = 0; p < h.length; p++) {
        ...
        if (q > g)
          var w = g,
            ...
            q = w;
        if (r.scaleBreaks)
          for (w = 0; !f && w < r.scaleBreaks._appliedBreaks.length; w++)
            f =
              r.scaleBreaks._appliedBreaks[w].startValue <= q &&
              r.scaleBreaks._appliedBreaks[w].endValue >= g;
        if (isFinite(r.dataInfo.minDiff))
          if (
            ((w = r.getApparentDifference(q, g, null, !0)),
            !(
              f ||
              (!(
                this.panEnabled &&
                ...
                ((r.logarithmic && w < Math.pow(r.dataInfo.minDiff, 3)) ||
                  (!r.logarithmic && w < 3 * Math.abs(r.dataInfo.minDiff)))) ||
              q < r.minimum ||
              g > r.maximum
            ))
          )
            A.push(r), n.push({ val1: q, val2: g }), (l = !0);
          else if (!e) {
            l = !1;
            break;
          }
    ...
    m.prototype.renderIndexLabels = function (a) {
      ...
      for (a = 0; a < this._indexLabels.length; a++) {
        var h = this._indexLabels[a],
          ...
          r,
          q,
          l = la("indexLabelFontColor", h.dataPoint, h.dataSeries),
        ...
        var p = la("indexLabelFontWeight", h.dataPoint, h.dataSeries),
          ...
          w = la("indexLabelLineDashType", h.dataPoint, h.dataSeries),
        ...
        if (null !== z && "" !== z) {
          ...
          if ("stackedarea100" === n) {
            ...
            if (
              ...
              Math.max.apply(null, h.dataPoint.y) < C.viewportMinimum ||
              Math.min.apply(null, h.dataPoint.y) > C.viewportMaximum
            )
              continue;
          } else if (
            0 <= n.indexOf("line") ||
            ...
            if (
              h.dataPoint.x < B.viewportMinimum ||
              h.dataPoint.x > B.viewportMaximum ||
              h.dataPoint.y < C.viewportMinimum ||
              h.dataPoint.y > C.viewportMaximum
            )
              continue;
          } else if (
            0 <= n.indexOf("column") ||
              ...
              : ((e = Math.max(h.bounds.y1, c.y1)),
                ...
                (b =
                  0 <= n.indexOf("range") || "error" === n
                    ? 0 < F
                      ? Math.max(h.bounds.y1, c.y1) + A / 2 + p
                      : Math.min(h.bounds.y2, c.y2) - A / 2 - p
                    : (Math.max(h.bounds.y1, c.y1) +
                        Math.min(h.bounds.y2, c.y2)) /
                      2),
                0 < F
                  ? ((q = Math.max(h.point.y, b) - A / 2),
                    q < e &&
                      ("bubble" === n || "scatter" === n) &&
                      (q = Math.max(h.point.y - A - p, c.y1 + p)))
                  : ((q = Math.min(h.point.y, b) - A / 2),
                    q > f - A - p &&
                      ("bubble" === n || "scatter" === n) &&
                      (q = Math.min(h.point.y + p, c.y2 - A - p))),
                (q = Math.min(q, f - A)));
          } else
            0 <= n.indexOf("line") ||
            0 <= n.indexOf("area") ||
          ...
          m &&
            ...
            0 <= n.indexOf("bar") || ("error" === n && h.axisSwapped)
              ...
              : d.lineTo(
                  r + l / 2,
                  q +
                    ((q < h.point.y ? A : -A) + ("horizontal" === x ? A : -A)) /
                      2
                ),
            d.stroke());
        }
    ...
    m.prototype.renderLine = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var f = [], p, l = 0; l < a.dataSeriesIndexes.length; l++) {
          ...
          var w = h._colorSet,
            k = (w = h.lineColor = h.options.lineColor
              ? h.options.lineColor
              : w[0]);
          c.strokeStyle = w;
          var m = !0,
                  ...
                  t < n.length - 1 &&
                    ...
                    c.setLineDash &&
                      (n[t].lineDashType
                        ...
                        : ((r = h.lineDashType), c.setLineDash(g))));
                  if (0 < n[t].markerSize || 0 < h.markerSize)
                    (B = h.getMarkerProperties(t, x, s, c)),
                      f.push(B),
                      (C = P(C)),
                      u &&
                        f.push({
        ...
        for (n = 0; n < a.dataSeriesIndexes.length; n++) {
          ...
          if (0 < w.length)
            for (
              ...
              if (
                (w[f].getTime ? (A = w[f].x.getTime()) : (A = w[f].x),
                !(
            ...
            for (h = 0; h < t.length; h++)
              if (
                ...
                if (
                  ...
                  (A[b] = t[h].y + (A[b] ? A[b] : 0)),
                    (B = a.axisY.convertValueToPixel(A[b])),
            ...
            for (
              ...
              if (
                ...
                if (
                  ...
                  (A[b] = r + ("undefined" !== typeof A[b] ? A[b] : 0)),
                    (B = a.axisY.convertValueToPixel(A[b])),
                    (r = p[b] ? p[b] : q),
                    (p[b] = B);
            ...
            for (h = 0; h < t.length; h++)
              if (
                ...
                if (
                  ...
                  (A[b] = t[h].y + (A[b] ? A[b] : 0)),
                    (n = p[b] ? p[b] : q),
                    (p[b] = B = a.axisY.convertValueToPixel(A[b]));
                else if (
            ...
            for (h = 0; h < t.length; h++)
              if (
                ...
                if (
                  ...
                  (A[b] = z + (A[b] ? A[b] : 0)),
                    (n = p[b] ? p[b] : q),
                    (p[b] = z = a.axisY.convertValueToPixel(A[b]));
    ...
    m.prototype.renderArea = function (a) {
      ...
      function b() {
        B &&
          ...
          f.fill(),
          (f.globalAlpha = 1),
          u && (p.lineTo(m, F), p.lineTo(B.x, F), p.closePath(), p.fill()),
          f.beginPath(),
          f.moveTo(m, t),
          p.beginPath(),
          p.moveTo(m, t),
        ...
        for (var r = 0; r < a.dataSeriesIndexes.length; r++) {
          ...
          if (0 < w.length) {
            ...
            for (var ja = !0; k < w.length; k++)
              if (
                ((s = w[k].x.getTime ? w[k].x.getTime() : w[k].x),
                !(
                ...
                if ("number" !== typeof w[k].y)
                  ...
                  k < w.length - 1 &&
                    (y !== (w[k].lineColor || v) ||
                      c !== (w[k].lineDashType || g.lineDashType)) &&
                    (b(),
                    (y = w[k].lineColor || v),
                    (f.strokeStyle = y),
                    f.setLineDash &&
                  ...
                  0 !== w[k].markerSize &&
                    (0 < w[k].markerSize || 0 < g.markerSize) &&
            ...
            for (w = !1; q < r.length; q++)
              if (
                ...
                if ("number" !== typeof r[q].y)
                  ...
                  q < r.length - 1 &&
                    (B !== (r[q].lineColor || F) ||
                      C !== (r[q].lineDashType || n.lineDashType)) &&
                    ((B = r[q].lineColor || F),
                    (s[s.length - 1].newStrokeStyle = B),
                    b.setLineDash &&
                      (r[q].lineDashType
                        ? ((C = r[q].lineDashType),
                          (s[s.length - 1].newLineDashArray = N(
              ...
              if (
                ...
                "number" !== typeof w[k].y
                  ...
                  : ((m = a.axisX.convertValueToPixel(s)),
                    ...
                    k < w.length - 1 &&
                      (y !== (w[k].lineColor || v) ||
                        S !== (w[k].lineDashType || g.lineDashType)) &&
                      (b(),
                      (y = w[k].lineColor || v),
                      (f.strokeStyle = y),
                      f.setLineDash &&
            ...
            for (var Z = !0, q = 0; q < n.length; q++) {
              ...
              if (
                ...
                if ("number" !== typeof fa.y)
                  ...
                  x || Z
                    ? (!x && C.connectNullData
                        ? (b.setLineDash &&
                            ...
                            h.push(z),
                            h.push(x),
                            (z = C.nullDataLineDashType),
                            b.setLineDash(R)),
                          b.lineTo(g, k),
                          u && s.lineTo(g, k))
                        : (b.beginPath(),
                          b.moveTo(g, k),
                          u && (s.beginPath(), s.moveTo(g, k))),
                      (Z = x = !1))
                    : (b.lineTo(g, k),
                      u && s.lineTo(g, k),
                      0 == q % 250 &&
                  ...
                  q < v.length - 1 &&
                    (S !== (v[q].lineColor || y) ||
                      z !== (v[q].lineDashType || C.lineDashType)) &&
                    (d(),
                    b.beginPath(),
                    b.moveTo(g, k),
                    h.push({ x: g, y: m - ma }),
                    ...
                    b.setLineDash &&
                      (v[q].lineDashType
                        ? ((z = v[q].lineDashType),
                          b.setLineDash(N(z, C.lineThickness)))
                        : ((z = C.lineDashType), b.setLineDash(D))));
                  ...
                  0 <= C.dataPointIndexes[f] &&
                    0 !== fa.markerSize &&
                    (0 < fa.markerSize || 0 < C.markerSize) &&
                    ((ma = C.getMarkerProperties(
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var e = [], v = 0; v < a.dataSeriesIndexes.length; v++) {
          ...
          for (q = 0; q < y.length; q++)
            (B = y[q].x.getTime ? y[q].x.getTime() : y[q].x),
              (C.dataPointIndexes[B] = q),
              e[B] || (n.push(B), (e[B] = !0));
          n.sort(Oa);
        }
            ...
            for (var Z = !0, q = 0; q < n.length; q++) {
              ...
              if (
                ...
                if ("number" !== typeof fa.y)
                  ...
                  s || Z
                    ? (!s && C.connectNullData
                        ? (b.setLineDash &&
                            ...
                            h.push(t),
                            h.push(s),
                            (t = C.nullDataLineDashType),
                            b.setLineDash(R)),
                          b.lineTo(g, w),
                          u && z.lineTo(g, w))
                        : (b.beginPath(),
                          b.moveTo(g, w),
                          u && (z.beginPath(), z.moveTo(g, w))),
                      (Z = s = !1))
                    : (b.lineTo(g, w),
                      u && z.lineTo(g, w),
                      0 == q % 250 &&
                  ...
                  q < y.length - 1 &&
                    (S !== (y[q].lineColor || D) ||
                      t !== (y[q].lineDashType || C.lineDashType)) &&
                    (d(),
                    b.beginPath(),
                    b.moveTo(g, w),
                    h.push({ x: g, y: x - ba }),
                    ...
                    b.setLineDash &&
                      (y[q].lineDashType
                        ? ((t = y[q].lineDashType),
                          b.setLineDash(N(t, C.lineThickness)))
                        : ((t = C.lineDashType), b.setLineDash(E))));
                  if (0 <= C.dataPointIndexes[f]) {
                  ...
                  0 <= C.dataPointIndexes[f] &&
                    0 !== fa.markerSize &&
                    (0 < fa.markerSize || 0 < C.markerSize) &&
                    ((ba = C.getMarkerProperties(q, g, w, b)),
                    l.push(ba),
                    (f = P(G)),
                    u &&
                      l.push({
    ...
    m.prototype.renderCandlestick = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
          ...
          if (0 < x.length)
            for (
              var z = 5 < w && t.bevelEnabled ? !0 : !1, l = 0;
              l < x.length;
              l++
            )
              if (
                ...
                (x[l].indexLabel ||
                  ...
                  this._indexLabels.push({
                    ...
                    dataPoint: x[l],
                    dataSeries: t,
                    point: { x: F + (B - F) / 2, y: a.axisY.reversed ? r : n },
                    direction: 1,
                    bounds: {
                      x1: F,
                      y1: Math.min(n, r),
    ...
    m.prototype.renderBoxAndWhisker = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (
          ...
          if (0 < z.length)
            for (
              var F = 5 < w && x.bevelEnabled ? !0 : !1, p = 0;
              p < z.length;
              p++
            )
              if (
                (z[p].getTime ? (g = z[p].x.getTime()) : (g = z[p].x),
                !(
                  g < a.axisX.dataInfo.viewPortMin ||
                  g > a.axisX.dataInfo.viewPortMax
                ) &&
                  !s(z[p].y) &&
                  z[p].y.length &&
                  "number" === typeof z[p].y[0] &&
                  "number" === typeof z[p].y[1] &&
                  "number" === typeof z[p].y[2] &&
                  "number" === typeof z[p].y[3] &&
                  "number" === typeof z[p].y[4] &&
                  5 === z[p].y.length)
              ) {
                ...
                var B = (l - w / 2) << 0,
                  ...
                  y = Math.round(Math.max(1, 0.15 * w)),
                  D = 0 === y % 2 ? 0 : 0.5,
                  S = z[p].whiskerColor
                    ? z[p].whiskerColor
                    : z[p].color
                    ...
                    : e,
                  R =
                    "number" === typeof z[p].whiskerThickness
                      ? z[p].whiskerThickness
                      : "number" === typeof x.options.whiskerThickness
                      ? x.whiskerThickness
                      : y,
                  E = z[p].whiskerDashType
                    ? z[p].whiskerDashType
                    : x.whiskerDashType,
                  ...
                  ma = z[p].stemColor
                    ...
                    : e,
                  ba =
                    "number" === typeof z[p].stemThickness
                      ? z[p].stemThickness
                  ...
                  I = z[p].lineColor
                    ...
                    : e,
                  M =
                    "number" === typeof z[p].lineThickness
                      ? z[p].lineThickness
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var x = 0; x < a.dataSeriesIndexes.length; x++) {
          var z = a.dataSeriesIndexes[x],
            ...
            D = 0;
          if (C)
            for (e = F._linkedSeries.id, t = 0; t < e; t++)
              !this.data[t].type.match(/(bar|column)/gi) ||
                !this.data[t].visible ||
          ...
          l = this.options.dataPointMaxWidth
            ...
            ? Math.min(
                0.15 * this.height,
                0.9 * (this.plotArea.height / (C ? v : 1))
              ) << 0
            : 0.3 * this.width;
          f &&
            (l = this.options.dataPointMaxWidth
          ...
          t = this.options.dataPointWidth
            ...
            : (0.9 *
                (((b ? p.height : p.width) *
                  (a.axisX.logarithmic
                    ? Math.log(ka) / Math.log(a.axisX.range)
                    : Math.abs(ka) / Math.abs(a.axisX.range))) /
                  (C ? v : 1))) <<
              0;
          this.dataPointMaxWidth &&
            e > l &&
          ...
          t > l && (t = l);
          if (0 < B.length)
            for (var E = F._colorSet, l = 0; l < B.length; l++) {
              var e = (F.lineColor = F.options.color ? F.options.color : E[0]),
                S = {
                  color: B[l].whiskerColor
                    ...
                    ? F.whiskerColor
                    : e,
                  thickness: s(B[l].whiskerThickness)
                    ? F.whiskerThickness
                    : B[l].whiskerThickness,
                  dashType: B[l].whiskerDashType
                    ? B[l].whiskerDashType
                    : F.whiskerDashType,
                  length: s(B[l].whiskerLength)
                    ? s(F.options.whiskerLength)
                      ? t
                      : F.options.whiskerLength
                    : B[l].whiskerLength,
                  trimLength: s(B[l].whiskerLength)
                    ? s(F.options.whiskerLength)
                      ? 50
                      : 0
                    : 0,
              ...
              if (
                ...
                b
                  ? ((q = a.axisX.reversed
                      ? (h + ((C ? v : 1) * t) / 2 - (C ? D - 1 : 0) * t) << 0
                      : (h - ((C ? v : 1) * t) / 2 + (C ? D - 1 : 0) * t) << 0),
                    (g = a.axisX.reversed ? (q - t) << 0 : (q + t) << 0))
                  : ((n = a.axisX.reversed
                      ? (k + ((C ? v : 1) * t) / 2 - (C ? D - 1 : 0) * t) << 0
                      : (k - ((C ? v : 1) * t) / 2 + (C ? D - 1 : 0) * t) << 0),
            ...
            for (var S = !0; g < r.length; g++)
              if (
                ...
                if (
                  ...
                  g < r.length - 1 &&
                    (B !== (r[g].lineColor || F) ||
                      C !== (r[g].lineDashType || n.lineDashType)) &&
                    (d(),
                    (B = r[g].lineColor || F),
                  ...
                  if (
                    ...
                    R = n.getMarkerProperties(g, m, s, b);
                    f.push(R);
                    E = P(t);
                    u &&
                      f.push({
            ...
            for (g = !1; r < n.length; r++)
              if (
                ...
                if (
                  ...
                  r < n.length - 1 &&
                    (z !== (n[r].lineColor || x) ||
                      F !== (n[r].lineDashType || h.lineDashType)) &&
                    ((z = n[r].lineColor || x),
        ...
        for (var g = 0; g < a.dataSeriesIndexes.length; g++) {
          ...
          if (0 < v.length)
            for (
              ...
              if (
                (v[p].getTime ? (n = v[p].x.getTime()) : (n = v[p].x),
                "number" !== typeof v[p].y)
              ) {
                if (0 < p && !F && s.connectNullData)
                  var y =
                ...
                0 < p &&
                  B &&
                  (!F || s.connectNullData) &&
                  (F && c.setLineDash && c.setLineDash(N(y, t)),
                  c.beginPath(),
                  c.moveTo(B, C - x),
                  c.lineTo(S, R - x),
                  0 < t && c.stroke(),
    ...
    m.prototype.renderPie = function (a) {
      ...
      function f(a, c, d) {
        ...
        if (0 <= a && a < n.length) {
          ...
          l =
            "right" === k.hemisphere
              ? z.x + Math.sqrt(Math.pow(u, 2) - Math.pow(c - z.y, 2))
              : z.x - Math.sqrt(Math.pow(u, 2) - Math.pow(c - z.y, 2));
          ...
          h &&
            ...
            (c =
              "right" === k.hemisphere
                ? z.x + Math.sqrt(Math.pow(u, 2) - Math.pow(d - z.y, 2))
                : z.x - Math.sqrt(Math.pow(u, 2) - Math.pow(d - z.y, 2))),
      ...
      function p() {
        ...
        for (
          ...
          if ("inside" !== h.indexLabelPlacement) {
            ...
            for (var s, t, a = 0; a < n.length; a++) {
              ...
              if (null !== B) {
                ...
                var y = 0,
                  y = b(s, t) - m;
                if (0 > y) {
                  for (var F = (t = 0), J = 0; J < n.length; J++)
                    J !== a &&
            ...
            for (a = 0; a < n.length; a++)
              (p = g[a]),
                (u = "pie" === h.type ? 0.7 * C : 0.8 * C),
                (B = z.x + u * Math.cos(p.midAngle)),
                (t = z.y + u * Math.sin(p.midAngle)),
                (p.indexLabelTextBlock.x = B),
                (p.indexLabelTextBlock.y = t);
          for (a = 0; a < n.length; a++)
            if (
              ((p = g[a]),
              (B = p.indexLabelTextBlock.measureText()),
              0 !== B.height && 0 !== B.width)
            )
              (B = B = 0),
                "right" === p.hemisphere
                  ? ((B =
                ...
                0 < B &&
                  (!l &&
                    ...
                    0.3 * p.indexLabelTextBlock.maxWidth > t
                      ? (p.indexLabelText = "")
                      : (p.indexLabelTextBlock.maxWidth = 0.85 * t),
                    0.3 * p.indexLabelTextBlock.maxWidth < t &&
                      (p.indexLabelTextBlock.x -=
                  ...
                  ((B /= Math.abs(Math.cos(p.indexLabelAngle))),
                  9 < B && (B *= 0.3),
                  B > d && (d = B)),
                (B = B = 0),
                  ...
                  (!l &&
                    ...
                    ((t =
                      0 < p.indexLabelAngle && p.indexLabelAngle < Math.PI
                        ...
                        : 1),
                    0 === f(a, B * t) && f(a, 2 * t)),
                  Math.abs(p.indexLabelTextBlock.x - z.x) < C &&
                    ((B /= Math.abs(Math.sin(p.indexLabelAngle))),
                    9 < B && (B *= 0.3),
                    B > d && (d = B)));
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var B = 0; B < n.length; B++)
          (y += Math.abs(n[B].y)),
            !a &&
              "undefined" !== typeof n[B].indexLabel &&
              null !== n[B].indexLabel &&
              0 < n[B].indexLabel.toString().length &&
              (a = !0),
            !a &&
              "undefined" !== typeof n[B].label &&
              null !== n[B].label &&
              0 < n[B].label.toString().length &&
              (a = !0);
        if (0 !== y) {
          a =
            a ||
    ...
    m.prototype.renderFunnel = function (a) {
        ...
        if (e)
          for (l = H.length - 1; 0 <= l; l--)
            (a = O[l]),
              ...
              t.reversed
                ? (H[l].textBlock.y + H[l].height > T + F &&
                    (H[l].textBlock.y = T + F - H[l].height),
                  H[l].textBlock.y < ra - F && (H[l].textBlock.y = ra - F))
                : (H[l].textBlock.y < T - F && (H[l].textBlock.y = T - F),
                  H[l].textBlock.y + H[l].height > ra + F &&
                    (H[l].textBlock.y = ra + F - H[l].height));
      }
      function f() {
        var a, b, c, d;
          ...
          for (var e = 0; e < O.length; e++)
            0 == H[e].textBlock.text.length
              ...
              : ((a = O[e]),
                ...
                t.reversed
                  ? (H[e].textBlock.y + H[e].height > T + F &&
                      (H[e].textBlock.y = T + F - H[e].height),
                    H[e].textBlock.y < ra - F && (H[e].textBlock.y = ra - F))
                  : (H[e].textBlock.y < T - F && (H[e].textBlock.y = T - F),
                    H[e].textBlock.y + H[e].height > ra + F &&
      ...
      function l(a, b) {
        return (
          (b < O.length ? H[b].textBlock.y : t.reversed ? T + F : ra + F) -
          (0 > a
            ? t.reversed
              ? ra - F
              : T - F
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        for (
          var t = this.data[a.dataSeriesIndexes[0]],
            ...
            C = 0,
            D = z.height - 2 * F,
            E = Math.min(z.width - 2 * B, 2.8 * z.height),
            I = !1,
            R = 0;
          R < x.length;
          R++
            ...
            if (
              ...
              for (G = 0; G < O.length; G++)
                (O[G].x1 += C),
                  ...
                  (O[G].x3 += C),
                  (O[G].x4 += C),
                  O[G].x5 && ((O[G].x5 += C), (O[G].x6 += C)),
                  (H[G].textBlock.x += C);
            }
            for (G = 0; G < O.length; G++)
              (C = O[G]), pa(P, C, t.fillOpacity), ga.push(C.y1);
            v(P);
            I &&
              t.visible &&
            ...
            for (var x = 0; x < r.dataPoints.length; x++) {
              var z = r.dataPoints[x],
                ...
                t = z.legendMarkerBorderThickness
                  ...
                  : r.legendMarkerBorderThickness
                  ? r.legendMarkerBorderThickness
                  : z.markerBorderThickness || r.markerBorderThickness
                  ? Math.max(1, Math.round(0.2 * u))
                  : 0,
              ...
              (z.showInLegend || (r.showInLegend && !1 !== z.showInLegend)) &&
                k.push(q);
            }
      }
        ...
        for (N = []; 4 > u; ) {
          ...
          if (b && 0 < b.length)
            for (g = b.length - 1; 0 <= g; g--)
              b[g] &&
                ((l = Math.round(f.y1)),
                (h = Math.round(f.y1 + (C[g] + b[g].margin + G))),
    ...
    D.prototype.calculateBreaksSizeInValues = function () {
      for (
        ...
        (e = b || !s(d[f].options.spacing)),
          (d[f].spacing =
            Qa(d[f].spacing, a, 8, e ? 0.1 * a : 8, e ? 0 : 3) << 0),
      ...
      if (this.snapToDataPoint) {
        ...
        if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
          ...
          if (
            ...
            w = this.parent.dataSeries[0].axisX.convertPixelToValue({ y: d });
          else if (
            "left" === this.parent._position ||
            "right" === this.parent._position
          )
            w = this.parent.convertPixelToValue({ y: d });
          for (var v = 0; v < this.parent.dataSeries.length; v++)
            (u = this.parent.dataSeries[v].getDataPointAtX(w, !0)) &&
              0 <= u.index &&
              ((u.dataSeries = this.parent.dataSeries[v]),
          ...
          if (
            ...
            for (
              ...
              if (n[w].dataPoint.y && n[w].dataPoint.y.length)
                for (var x = 0; x < n[w].dataPoint.y.length; x++)
                  (t = Math.abs(
                    a - this.parent.convertValueToPixel(n[w].dataPoint.y[x])
                  )),
                    t < u && ((u = t), (v = w));
              else
                (t = Math.abs(
                  a - this.parent.convertValueToPixel(n[w].dataPoint.y)
                )),
                  t < u && ((u = t), (v = w));
            ...
            for (
              ...
              if (n[w].dataPoint.y && n[w].dataPoint.y.length)
                for (x = 0; x < n[w].dataPoint.y.length; x++)
                  (t = Math.abs(
                    a - this.parent.convertValueToPixel(n[w].dataPoint.y[x])
                  )),
                    t < u && ((u = t), (v = w));
            ...
            for (
              ...
              if (n[w].dataPoint.y && n[w].dataPoint.y.length)
                ...
                (z += n[w].dataPoint.y),
                  (y = n[w].dataPoint.x.getTime
                    ? n[w].dataPoint.x.getTime()
                    : n[w].dataPoint.x),
                  (y = 100 * (z / n[w].dataSeries.plotUnit.dataPointYSums[y])),
          ...
          if (
            ...
            if (
              ...
              for (w = t = 0; w < x.dataPoint.y.length; w++)
                (t = Math.abs(
                  a - this.parent.convertValueToPixel(x.dataPoint.y[w])
                )),
                  t < u && ((u = t), (b = w));
              l =
                1 === q.lineWidth % 2
            ...
            if (this.parent.labels)
              for (
                n = Math.ceil(this.parent.interval), w = 0;
                w < this.parent.viewportMaximum;
                w += n
              )
          ...
          if (y) {
            if ("axisX" === this.parent.type)
              for (
                w = this.parent.convertPixelToValue({ x: a }), u = null, v = 0;
                v < this.parent.dataSeries.length;
                v++
              )
                (u = this.parent.dataSeries[v].getDataPointAtX(w, !0)) &&
          ...
          if (
            ...
            for (
              ...
              if (n[w].dataPoint.y && n[w].dataPoint.y.length)
                for (x = 0; x < n[w].dataPoint.y.length; x++)
                  (t = Math.abs(
                    d - this.parent.convertValueToPixel(n[w].dataPoint.y[x])
                  )),
                    t < u && ((u = t), (v = w));
              else
                (t = Math.abs(
                  d - this.parent.convertValueToPixel(n[w].dataPoint.y)
                )),
                  t < u && ((u = t), (v = w));
          else if (
          ...
          if (
            ...
            for (w = t = 0; w < x.dataPoint.y.length; w++)
              (t = Math.abs(
                d - this.parent.convertValueToPixel(x.dataPoint.y[w])
              )),
                t < u && ((u = t), (b = w));
            m =
              1 === q.lineWidth % 2
      ...
      if (!this.chart.disableToolTip) {
        ...
        if (
          ...
          if ((h = this.chart.getDataPointAtXY(a, d, c)))
            ...
            if (
              ((h = Xa(a, d, this.chart._eventManager.ghostCtx)),
              0 < h &&
